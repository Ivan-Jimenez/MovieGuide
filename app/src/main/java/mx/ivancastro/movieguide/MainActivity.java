...
import mx.ivancastro.movieguide.details.MovieDetailsActivity;
import mx.ivancastro.movieguide.details.MovieDetailsFragment;
import mx.ivancastro.movieguide.util.RxUtils;
import mx.ivancastro.movieguide.util.EspressoIdlingResource;
import com.jakewharton.rxbinding2.support.v7.widget.RxSearchView;
import java.util.concurrent.TimeUnit;
import io.reactivex.disposables.Disposable;
import mx.ivancastro.movieguide.listing.MoviesListingFragment;


public class MainActivity extends AppCompatActivity implements MoviesListingFragment.Callback {
